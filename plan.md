...
### 2026-04-23: 라피스 롤백 + 사피아(SPA) 신규 (20명)

- 커밋 0 (`bf363e4`): 이미지 원본 경로 `연예계/char_img/`로 통일 · 레거시 폴더 `_OLD_DO_NOT_USE_*`로 rename · Apphireah 교정 (10 파일)
- 커밋 1 (`ff01236`): 라피스 이미지 자산 swap · R2 LPS 98 재업로드 · ASSET_VERSION 26→27 · 자매 로어북 삭제
- 커밋 2 (`d40ff0d`): 사피아 characters.js 엔트리 신규 · 로어북 5개 신규 · 자매 로어북 신규 · 아피리아 로어북 3개 라피스→사피아 치환 · 메인 프롬프트 chars/img.codes · 매니저모드 기타_11→12명 · 플랫폼 풀어쓰기 md · ASSET_VERSION 27→28 · R2 SPA 104 업로드
- 커밋 3: 에덴챗 HTML v=24→v=28 (43건) + 아피리아·사피아 카드 · 세계관 프로필 사피아 블록 · CLAUDE.md 20명 · 빌드 검증
- 핵심 설정: 사피아=APPAIREL & DESIGN 오너(디자이너·모델·스타일리스트) · 20대 후반 · 무소속 · 자매 이상의 애정 · 손목 잡기+소매 끝 만지기 시그니처 · 플래티넘 초커 · 존댓말
- 라피스 롤백: 로우 포니테일 · 빈유 · 스트리트 룩 · 쿨한 반말 · 아피리아와 무관해짐
- 주의: 라피스 key/thumbnail은 백업에 없어 장발하프업 유지 (사용자 재생성 대기)
