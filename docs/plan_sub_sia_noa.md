...
| 외모 | 쌍둥이 언니, 168cm, 아이보리 백발, 다크블루 눈 | 쌍둥이 동생, 172cm, 쿨톤 플래티넘, 다크블루 눈 |
| 가슴 | large breasts (둘 다 동일) | large breasts (둘 다 동일) |
| 성격 | ENTP 7w8 / 쾌활, 장난기, 교활, 스킨십 거리낌없음 | ISTJ 1w9 / 과묵, 다독, 감정 표현 서투름, 내면 다정 |

### 0-2. 확정된 방향

- **소꿉친구 설정**: X (사용하지 않음). 프라임시티에서 새로운 만남.
...
- 시아: `oklch(0.72 0.14 250)` — 생기있는 블루 (방송인/에너지)
- 노아: `oklch(0.68 0.08 280)` — 차분한 라벤더 (모델/우아함)
...
```javascript
  // ── 16. 시아 ── Route 0 인플루언서 ──
  {
    ...
    description:
      "노아의 쌍둥이 언니. SNS와 인터넷 방송으로 자체 팬덤을 구축한 인플루언서. 쾌활하고 장난기 넘치지만, 화면 뒤에서는 '방송인 시아'와 '진짜 시아' 사이에서 흔들린다.",
    brief:
      "노아의 쌍둥이 언니. 인터넷 방송과 SNS로 자체 팬덤을 형성한 Route 0의 인플루언서. 언제나 쾌활하고 장난기 넘치지만, 완벽해야 한다는 인플루언서의 가면과 진짜 자신 사이에서 갈등한다.",
    job: "인플루언서 / 크리에이터",
    background:
      "쌍둥이 동생 노아와 함께 Route 0에 머물며 연예계에 도전 중. 정규 에이전시 없이 1인 미디어로 성장했지만, 그만큼 자본과 인맥의 한계를 체감하고 있다.",
  ...
  // ── 17. 노아 ── Route 0 패션 모델 ──
  {
    ...
    description:
      "시아의 쌍둥이 동생. 프리랜서 패션 모델로 활동하며 조용히 자기 길을 걷는 사람. 감정 표현이 서투르지만, 행동 하나하나에 깊은 배려가 담겨 있다.",
    brief:
      "시아의 쌍둥이 동생. 과묵하고 감정 표현에 서투르지만, 행동으로 마음을 보여주는 사람. 표현력 넘치는 언니와 자신을 비교하며 무뚝뚝함이 오해를 살까 두려워한다. 말보다 손이 먼저 움직이는 조용한 다정함.",
    job: "패션 모델",
    background:
      "쌍둥이 언니 시아와 함께 Route 0에 머물며 프리랜서 모델로 활동. 패션 화보 위주로 커리어를 쌓고 있지만 무대 경험은 부족하다. 체계적이고 성실한 성격.",
