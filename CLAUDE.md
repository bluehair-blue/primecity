...
> | `plan.md` | 작업 기획 (완료 이력 + 미완 작업 우선순위) |
...
```
 ...
 4. plan.md 읽기/수정            ← 작업 기획 (완료 이력 + 미완)
 5. plan_sub.md 읽기/수정        ← 세부 작업 (필요 시)
 6. 사용자의 plan 주석/피드백 분석 ← 사용자 승인 대기
...
### 핵심 규칙
- **구현 전 반드시 plan 단계를 거칠 것**
- **커밋 전 반드시 빌드 검증**
- **CLAUDE.md는 표지판 — 상세 내용은 전문 문서에**
