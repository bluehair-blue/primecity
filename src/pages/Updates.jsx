...
const updates = [
  {
    ...
    items: [
      ...
      "이미지 원본 경로 통일 — 프로젝트 루트/char_img 단일화 + 아피리아 영문 표기 Apphireah로 교정",
    ],
  },
  {
    date: "2026.04.19",
  ...
  },
  {
    ...
    items: [
      "연습생모드 12파일 분리 — 본체 + 시작 + 4기획사 분기(💎PRISM·🌙Blue Moon·🔻APEX·🌱Route 0) + 6서브(공개평가·멘토링·퇴소·부상·그룹매칭·데뷔)",
      "배우모드 11파일 분리 — 본체 + 시작 + 4기획사 분기(🎭PRISM·🎬Blue Moon·🎞️APEX·📜Route 0) + 5페이즈(오디션·촬영·방영·홍보·스캔들)",
      "작곡가모드 7파일 — 분기 없는 프리랜서 통합형 + 이서하 라포 7단계 미발표곡 아크",
      "캐릭터 과거 회상 7명 신규 — 밀라 · 라피스 · 미모리 · 시아 · 노아 · 에르피 · 진시혁",
      "18원칙(서브-분기 책임 분리) — 서브는 이벤트 골격, 분기는 기획사별 톤/대응 패턴 분리",
      "분기 이모지 유지제 — 4기획사 분기마다 고유 이모지로 상태창 활성 표시",
      "신인/경력직 분기 — 모든 직업군 모드에 입직 단계 선택지 추가",
      "ASSET_VERSION 19 — R2 sync 1631/1632 완료 (JGR/93 1장 누락 다음 세션 보강 예정)",
    ],
  },
  {
    date: "2026.04.14",
    ...
    items: [
      ...
      "매니저모드 B분기 강화 — 7캐릭터별 매니저 로어북 분리(강하람·나하린·노아·시아·에르피·에리카·한소리)",
