...
export const characters = [
  ...
  // ── 20. 사피아 ── 무소속 디자이너 (아피리아의 자매 · APPAIREL & DESIGN 오너) ──
  {
    id: "sapphire",
    cdnId: "SPA",
    name: "사피아",
    ...
    role: "디자이너 · 모델 · 스타일리스트",
    age: "20대 후반",
    tagline: "언니의 길을 조각하는 사람입니다.",
    color: "oklch(0.70 0.16 240)",
    image: cdnUrl("SPA/key.webp"),
    thumbnail: cdnUrl("SPA/thumbnail.webp"),
    profile: cdnUrl("SPA/profile.webp"),
    sign: cdnUrl("SPA/sign.webp"),
    detailPath: "/characters/sapphire",
    signature: "손목 잡기(긴장) · 소매 끝 만지기(관찰) — 상황별 두 제스처",
    personality: "무표정이되 속은 예민한 보호적 방어벽",
    description:
      "개인 하이엔드 패션 브랜드 APPAIREL & DESIGN의 오너. 디자이너이자 모델이자 스타일리스트. 언니 아피리아의 모든 이미지를 사피아가 조각한다. 성씨는 공개되지 않는다 — 자매라는 사실이면 충분하다고 여긴다.",
    brief:
      "겉은 고요하고 침묵이 많지만 속은 예민하다. 언니 아피리아가 세상에 자기를 드러내는 여유를 보여준다면, 사피아는 언니가 상처받지 않도록 보이지 않는 방어벽을 세운다. 자매라는 호칭이 닿지 못할 만큼 언니를 특별히 아끼며, 자기 삶의 순서에서 언제나 언니를 앞에 둔다. 손목을 잡는 제스처는 자기 긴장의 발화이며, 소매 끝을 만지는 제스처는 세상을 관찰할 때의 습관이다.",
    job: "APPAIREL & DESIGN 오너 · 디자이너 · 모델 · 스타일리스트",
    background:
      "프라임시티 밖에서도 이름이 알려진 디자이너. 개인 브랜드 APPAIREL & DESIGN을 운영하며 아피리아의 공식 이미지 전반을 담당한다. 언니와 함께 무소속 라인을 형성하고, 정기 스케줄보다 필요한 순간에만 모습을 드러낸다. 플래티넘 초커는 언니의 은색과 마주 본 자매의 표식.",
    taste: "고요한 공간, 짧은 문장, 긴 시선. 사람을 읽는 데 시간을 쓰고 말을 아낀다.",
    goal: "언니가 다치지 않도록 곁을 지키는 것. 자신의 브랜드로 언니의 모든 순간을 조각하는 것.",
    expressions: EXPRESSION_KEYS,
  },
];
